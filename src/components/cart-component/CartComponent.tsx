    ...
    <div>
      <div className='flex pt-3 pb-5 border-b-1 border-b-lineGray gap-2'>
        ...
        <div className='flex justify-between flex-1'>
          <div>
            <h3 className='text-Gray font-[700] mx-[3px] leading-5 text-sm'>Bradly</h3>
            ...
            <div className='mt-2'>
              <p className='text-Gray text-sm leading-5 mx-[3px]'>Model: <span className='font-[700]'>SAE731</span></p>
              <p className='text-Gray text-sm leading-5 mx-[3px]'>Mfr. Model No.: 4155-B</p>
            </div>
          </div>
          <div className='text-right'>
            <p className='text-Gray font-[700] mx-[3px] leading-5 text-sm'>$10.59 / Each</p>
            <p className='text-Gray font-[700] mx-[3px] leading-5 text-sm mt-2'>Qty.: 1</p>
          </div>
        </div>
      </div>

      <div className='py-4'>
        <p className='text-sm text-Gray leading-6 text-right'>7 item(s) in your cart.</p>
      ...
      <div className='bg-lightMain text-center text-mainColor leading-5 text-sm p-2'>
        <p>
          ...
          FREE delivery on all orders over <span className='font-[700]'>$99</span> when shipping to an <br /> <span className='font-[700] underline'>eligible location.</span>
        </p>
      </div>
      ...
      <div className='text-[#428bca] leading-5 text-[12px] p-2 border-l-4 border-l-[#428bca] bg-[#f0f7fd] mt-4'>
        FREE gift on orders of $499+. Code: APRIL24. <br /> <span className='font-[700] underline'>Learn more</span>
      </div>
