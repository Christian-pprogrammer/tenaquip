      ...
      <div className='md:flex gap-6'>
        <div className="flex-1">
          ...
          >
            ...
            <h3 className='text-Gray text-lg font-semibold'>Your Contact information</h3>
            ...
            <div className="grid md:grid-cols-2 gap-x-6">
              ...
              <div className="first_name">
                ...
                <input
                  ...
                  id="first_name"
                  name="first_name"
                  className={`custom-input ${formik.touched.first_name &&
              ...
              <div className="last_name">
                ...
                <input
                  ...
                  id="last_name"
                  name="last_name"
                  className={`custom-input ${formik.touched.last_name &&
              ...
              <div className="phone">
                ...
                <input
                  ...
                  id="phone"
                  name="phone"
                  className={`custom-input ${formik.touched.phone && formik.errors.phone && "error-input"
                    }`}
                  onBlur={formik.handleBlur}
                  onChange={formik.handleChange}
              ...
              <div className="email">
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  className={`custom-input ${formik.touched.email && formik.errors.email && "error-input"
                    }`}
                  onBlur={formik.handleBlur}
                  onChange={formik.handleChange}
            ...
            <h3 className='text-Gray text-lg font-semibold'>Delivery Address</h3>

            <Link href="#" className='text-[13px] text-mainColor hover:underline'>
